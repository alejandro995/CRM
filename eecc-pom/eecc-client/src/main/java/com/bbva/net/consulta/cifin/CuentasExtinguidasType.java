...
/**
 * <p>Clase Java para CuentasExtinguidasType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="CuentasExtinguidasType">
 *   &lt;complexContent>
...
@XmlType(name = "CuentasExtinguidasType", propOrder = {
    "obligacion"
})
public class CuentasExtinguidasType {
