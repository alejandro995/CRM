...
import com.bbva.ccol.loans.facade.v02.impl.SrvLoansV02;
...
public Loan modifyDisbursementLoan(String loanId, String disbursementId, DataDisbursement disbursement,
	...
	public DataLoan modifyLoan(String loanId, Loan loan, Map<String, String> headers) throws Exception {
        ...
        */
    @Override
    public Loan getLoan(String loanId, Map<String, String> headers) throws Exception {
         try{
           System.out.println(URL_SERVICE);
        SrvLoansV02 srv = (SrvLoansV02)getClient(URL_SERVICE, SrvLoansV02.class);
            HeaderUtils.applyHeaders(WebClient.client(srv), headers);
            
            Response res= srv.getLoanResume("1");
            System.out.println("Tuvo respuesta del servicio");
            evaluateResponse(res);
            
            
            return res.readEntity(Loan.class);
        }catch(Exception e){
